...
public interface PointFacade {
  ...
  @ResponseBody
  List<PointTO> getFilterList(@RequestParam(value = "id", required = false) String id,
      @RequestParam("typeIn") ArrayList<Integer> typeIn,
      @RequestParam(value = "userId", required = false) String userId,
      @RequestParam("userIdIn") ArrayList<String> userIdIn,
  ...
  @ResponseBody
  List<PointTO> getFilterDetailList(@RequestParam(value = "id", required = false) String id,
      @RequestParam("typeIn") ArrayList<Integer> typeIn,
      @RequestParam(value = "userId", required = false) String userId,
      @RequestParam("userIdIn") ArrayList<String> userIdIn,
      @RequestParam(value = "relationId", required = false) String relationId,
  ...
  PointTO getSingleByPK(@RequestParam(value = "id", required = true) String id);

  @RequestMapping(
      value = "",
      method = RequestMethod.POST
  )
  void post(@RequestBody PointTO entityTO);

  @RequestMapping(
      value = "",
      method = RequestMethod.PATCH
  )
  void patch(@RequestBody PointTO entityTO);
