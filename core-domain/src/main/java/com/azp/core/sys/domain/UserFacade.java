...
public interface UserFacade {
  ...
  List<UserTO> getFilterList(@RequestParam(value = "id", required = false) String id,
      @RequestParam("userCodeIn") ArrayList<String> userCodeIn,
  ...
  @ResponseBody
  List<UserTO> getListByRelatedId(@RequestBody ArrayList<String> idList);
  ...
  @ResponseBody
  List<UserTO> getListByRelatedDepartmentId(@RequestBody ArrayList<String> departmentIdList);
}
