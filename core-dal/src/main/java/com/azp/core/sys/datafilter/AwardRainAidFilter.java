...
public class AwardRainAidFilter {
  public static AwardRainAidDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    AwardRainAidDOExample example = new AwardRainAidDOExample();
    ...
    AwardRainAidDOExample.Criteria criteria = example.createCriteria();
