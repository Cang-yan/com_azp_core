...
public class PointFilter {
  public static PointDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    PointDOExample example = new PointDOExample();
    ...
    PointDOExample.Criteria criteria = example.createCriteria();
    ...
    if (filterMap.get("userIdIn") != null) criteria.andUserIdIn((List) filterMap.get("userIdIn"));
    if (filterMap.get("relationId") != null) criteria.andRelationIdEqualTo((String) filterMap.get("relationId"));
    if (filterMap.get("relationIdIn") != null) criteria.andRelationIdIn((List) filterMap.get("relationIdIn"));
    if (filterMap.get("getTimeFrom") != null) criteria.andGetTimeGreaterThan(new Date((Long) filterMap.get("getTimeFrom")));
    if (filterMap.get("getTimeTo") != null) criteria.andGetTimeLessThan(new Date((Long) filterMap.get("getTimeTo")));
    if (filterMap.get("templateId") != null) criteria.andTemplateIdEqualTo((String) filterMap.get("templateId"));
    if (filterMap.get("templateIdIn") != null) criteria.andTemplateIdIn((List) filterMap.get("templateIdIn"));
