...
public class UserPointStatisticsFilter {
  public static UserPointStatisticsDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    UserPointStatisticsDOExample example = new UserPointStatisticsDOExample();
    ...
    UserPointStatisticsDOExample.Criteria criteria = example.createCriteria();
    if (filterMap.get("id") != null) criteria.andIdEqualTo((String) filterMap.get("id"));
    if (filterMap.get("numberTo") != null) criteria.andNumberLessThan((Integer) filterMap.get("numberTo"));
    ...
    if (filterMap.get("departmentName") != null) criteria.andDepartmentNameEqualTo((String) filterMap.get("departmentName"));
    if (filterMap.get("countFrom") != null) criteria.andCountGreaterThanOrEqualTo((Integer) filterMap.get("countFrom"));
    if (filterMap.get("numberFrom") != null) criteria.andNumberGreaterThanOrEqualTo((Integer) filterMap.get("numberFrom"));
    if (filterMap.get("userId") != null) criteria.andUserIdEqualTo((String) filterMap.get("userId"));
    if (filterMap.get("countTo") != null) criteria.andCountLessThan((Integer) filterMap.get("countTo"));
