...
public class LevelFilter {
  public static LevelDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    LevelDOExample example = new LevelDOExample();
    ...
    LevelDOExample.Criteria criteria = example.createCriteria();
    if (filterMap.get("id") != null) criteria.andIdEqualTo((String) filterMap.get("id"));
    if (filterMap.get("idx") != null) criteria.andIdxEqualTo((Integer) filterMap.get("idx"));
  ...
  public static LevelDOExample initIdQueryFilter(List<String> idList) {
    LevelDOExample example = new LevelDOExample();
    example.setOrderByClause("gmt_create desc");
    LevelDOExample.Criteria criteria = example.createCriteria();
