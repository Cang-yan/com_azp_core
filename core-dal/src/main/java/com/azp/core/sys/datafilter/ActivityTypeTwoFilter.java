...
public class ActivityTypeTwoFilter {
  public static ActivityTypeTwoDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    ActivityTypeTwoDOExample example = new ActivityTypeTwoDOExample();
    ...
    ActivityTypeTwoDOExample.Criteria criteria = example.createCriteria();
  ...
  public static ActivityTypeTwoDOExample initActivitySubCategoryIdQueryFilter(List<String> activitySubCategoryIdList) {
    ActivityTypeTwoDOExample example = new ActivityTypeTwoDOExample();
    example.setOrderByClause("gmt_create desc");
    ActivityTypeTwoDOExample.Criteria criteria = example.createCriteria();
  ...
  public static ActivityTypeTwoDOExample initIdQueryFilter(List<String> idList) {
    ActivityTypeTwoDOExample example = new ActivityTypeTwoDOExample();
    example.setOrderByClause("gmt_create desc");
    ActivityTypeTwoDOExample.Criteria criteria = example.createCriteria();
