...
public class TipsFilter {
  public static TipsDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    TipsDOExample example = new TipsDOExample();
    ...
    TipsDOExample.Criteria criteria = example.createCriteria();
