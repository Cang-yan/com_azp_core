...
/**
 * sys_activity_type_four_periods
 * @author eamon
 */
public class ActivityTypeFourPeriodsDO implements Serializable {
    /**
     * 活动4-期数ID
     */
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        ActivityTypeFourPeriodsDO other = (ActivityTypeFourPeriodsDO) that;
