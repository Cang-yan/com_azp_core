...
public class NotificationFilter {
  public static NotificationDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    NotificationDOExample example = new NotificationDOExample();
    ...
    NotificationDOExample.Criteria criteria = example.createCriteria();
    if (filterMap.get("id") != null) criteria.andIdEqualTo((String) filterMap.get("id"));
    if (filterMap.get("title") != null) criteria.andTitleEqualTo((String) filterMap.get("title"));
  ...
  public static NotificationDOExample initIdQueryFilter(List<String> idList) {
    NotificationDOExample example = new NotificationDOExample();
    example.setOrderByClause("gmt_create desc");
    NotificationDOExample.Criteria criteria = example.createCriteria();
