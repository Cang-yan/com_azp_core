...
public class PointExchangeFilter {
  public static PointExchangeDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    PointExchangeDOExample example = new PointExchangeDOExample();
    ...
    PointExchangeDOExample.Criteria criteria = example.createCriteria();
    if (filterMap.get("id") != null) criteria.andIdEqualTo((String) filterMap.get("id"));
    if (filterMap.get("productId") != null) criteria.andProductIdEqualTo((String) filterMap.get("productId"));
    if (filterMap.get("pointNum") != null) criteria.andPointNumEqualTo((Integer) filterMap.get("pointNum"));
