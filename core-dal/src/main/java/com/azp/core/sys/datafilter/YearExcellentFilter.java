...
public class YearExcellentFilter {
  public static YearExcellentDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    YearExcellentDOExample example = new YearExcellentDOExample();
    ...
    YearExcellentDOExample.Criteria criteria = example.createCriteria();
