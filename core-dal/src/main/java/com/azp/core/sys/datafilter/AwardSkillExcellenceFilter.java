...
public class AwardSkillExcellenceFilter {
  public static AwardSkillExcellenceDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    AwardSkillExcellenceDOExample example = new AwardSkillExcellenceDOExample();
    ...
    AwardSkillExcellenceDOExample.Criteria criteria = example.createCriteria();
    ...
    if (filterMap.get("monthIn") != null) criteria.andMonthIn((List) filterMap.get("monthIn"));
    ...
    if (filterMap.get("awardName") != null) criteria.andAwardNameLike("%" + (String) filterMap.get("awardName") + "%");
