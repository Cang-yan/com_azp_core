...
public class ActivityCategoryFilter {
  public static ActivityCategoryDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    ActivityCategoryDOExample example = new ActivityCategoryDOExample();
    ...
    ActivityCategoryDOExample.Criteria criteria = example.createCriteria();
