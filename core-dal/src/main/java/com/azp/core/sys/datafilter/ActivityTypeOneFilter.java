...
public class ActivityTypeOneFilter {
  public static ActivityTypeOneDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    ActivityTypeOneDOExample example = new ActivityTypeOneDOExample();
    ...
    ActivityTypeOneDOExample.Criteria criteria = example.createCriteria();
  ...
  public static ActivityTypeOneDOExample initActivitySubCategoryIdQueryFilter(List<String> activitySubCategoryIdList) {
    ActivityTypeOneDOExample example = new ActivityTypeOneDOExample();
    example.setOrderByClause("gmt_create desc");
    ActivityTypeOneDOExample.Criteria criteria = example.createCriteria();
  ...
  public static ActivityTypeOneDOExample initIdQueryFilter(List<String> idList) {
    ActivityTypeOneDOExample example = new ActivityTypeOneDOExample();
    example.setOrderByClause("gmt_create desc");
    ActivityTypeOneDOExample.Criteria criteria = example.createCriteria();
