...
public class ActivityTypeFourPeriodsFilter {
  public static ActivityTypeFourPeriodsDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    ActivityTypeFourPeriodsDOExample example = new ActivityTypeFourPeriodsDOExample();
    ...
    ActivityTypeFourPeriodsDOExample.Criteria criteria = example.createCriteria();
  ...
  public static ActivityTypeFourPeriodsDOExample initPeriodsNumberQueryFilter(List<Integer> periodsNumberList) {
    ActivityTypeFourPeriodsDOExample example = new ActivityTypeFourPeriodsDOExample();
    example.setOrderByClause("gmt_create desc");
    ActivityTypeFourPeriodsDOExample.Criteria criteria = example.createCriteria();
