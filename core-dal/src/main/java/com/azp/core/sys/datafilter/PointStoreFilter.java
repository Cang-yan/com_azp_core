...
public class PointStoreFilter {
  public static PointStoreDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    PointStoreDOExample example = new PointStoreDOExample();
    ...
    PointStoreDOExample.Criteria criteria = example.createCriteria();
    if (filterMap.get("id") != null) criteria.andIdEqualTo((String) filterMap.get("id"));
    if (filterMap.get("productType") != null) criteria.andProductTypeEqualTo((Integer) filterMap.get("productType"));
  ...
  public static PointStoreDOExample initIdQueryFilter(List<String> idList) {
    PointStoreDOExample example = new PointStoreDOExample();
    example.setOrderByClause("gmt_create desc");
    PointStoreDOExample.Criteria criteria = example.createCriteria();
