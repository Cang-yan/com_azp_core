...
public class ActivityTypeThreeFilter {
  public static ActivityTypeThreeDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    ActivityTypeThreeDOExample example = new ActivityTypeThreeDOExample();
    ...
    ActivityTypeThreeDOExample.Criteria criteria = example.createCriteria();
    ...
    if (filterMap.get("isOutstanding") != null) criteria.andIsOutstandingEqualTo((Integer) filterMap.get("isOutstanding"));
    if (filterMap.get("createUserId") != null) criteria.andCreateUserIdEqualTo((String) filterMap.get("createUserId"));
  ...
  public static ActivityTypeThreeDOExample initIdQueryFilter(List<String> idList) {
    ActivityTypeThreeDOExample example = new ActivityTypeThreeDOExample();
    example.setOrderByClause("gmt_create desc");
    ActivityTypeThreeDOExample.Criteria criteria = example.createCriteria();
