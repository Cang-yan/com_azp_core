...
public class StudyNoteFilter {
  public static StudyNoteDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    StudyNoteDOExample example = new StudyNoteDOExample();
    ...
    StudyNoteDOExample.Criteria criteria = example.createCriteria();
    ...
    if (filterMap.get("activityTypeTwoUserId") != null) criteria.andActivityTypeTwoUserIdEqualTo((String) filterMap.get("activityTypeTwoUserId"));
  ...
  public static StudyNoteDOExample initActivityTypeTwoUserIdQueryFilter(List<String> activityTypeTwoUserIdList) {
    StudyNoteDOExample example = new StudyNoteDOExample();
    example.setOrderByClause("gmt_create desc");
    StudyNoteDOExample.Criteria criteria = example.createCriteria();
    if (activityTypeTwoUserIdList == null) activityTypeTwoUserIdList = new ArrayList<>();
    criteria.andActivityTypeTwoUserIdIn(activityTypeTwoUserIdList);
    return example;
  }
}
