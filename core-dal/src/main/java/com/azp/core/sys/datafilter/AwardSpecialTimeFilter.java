...
public class AwardSpecialTimeFilter {
  public static AwardSpecialTimeDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    AwardSpecialTimeDOExample example = new AwardSpecialTimeDOExample();
    ...
    AwardSpecialTimeDOExample.Criteria criteria = example.createCriteria();
