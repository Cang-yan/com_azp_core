...
public class AwardGoodEyeFilter {
  public static AwardGoodEyeDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    AwardGoodEyeDOExample example = new AwardGoodEyeDOExample();
    ...
    AwardGoodEyeDOExample.Criteria criteria = example.createCriteria();
    ...
    if (filterMap.get("quarterIn") != null) criteria.andQuarterIn((List) filterMap.get("quarterIn"));
