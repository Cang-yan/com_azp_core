...
/**
 * sys_activity_type_one
 * @author eamon
 */
public class ActivityTypeOneDO implements Serializable {
    /**
     * 类型1活动ID
     */
    private String id;
    ...
    public Integer getDePoint() {
        return dePoint;
    }

    public void setDePoint(Integer dePoint) {
    ...
    public boolean equals(Object that) {
        ...
        ActivityTypeOneDO other = (ActivityTypeOneDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getGetPoint() == null ? other.getGetPoint() == null : this.getGetPoint().equals(other.getGetPoint()))
            && (this.getDePoint() == null ? other.getDePoint() == null : this.getDePoint().equals(other.getDePoint()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGetPoint() == null) ? 0 : getGetPoint().hashCode());
        result = prime * result + ((getDePoint() == null) ? 0 : getDePoint().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", getPoint=").append(getPoint);
        sb.append(", dePoint=").append(dePoint);
