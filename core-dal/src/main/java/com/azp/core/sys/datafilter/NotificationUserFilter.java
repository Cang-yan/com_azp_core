...
public class NotificationUserFilter {
  public static NotificationUserDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    NotificationUserDOExample example = new NotificationUserDOExample();
    ...
    NotificationUserDOExample.Criteria criteria = example.createCriteria();
    if (filterMap.get("id") != null) criteria.andIdEqualTo((String) filterMap.get("id"));
    if (filterMap.get("notificationId") != null) criteria.andNotificationIdEqualTo((String) filterMap.get("notificationId"));
    ...
    if (filterMap.get("senderId") != null) criteria.andSenderIdEqualTo((String) filterMap.get("senderId"));
