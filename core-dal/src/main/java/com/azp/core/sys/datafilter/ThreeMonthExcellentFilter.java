...
public class ThreeMonthExcellentFilter {
  public static ThreeMonthExcellentDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    ThreeMonthExcellentDOExample example = new ThreeMonthExcellentDOExample();
    ...
    ThreeMonthExcellentDOExample.Criteria criteria = example.createCriteria();
    ...
    if (filterMap.get("threeMonth") != null) criteria.andThreeMonthEqualTo((String) filterMap.get("threeMonth"));
