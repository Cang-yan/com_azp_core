...
public class AwardSnowHeatFilter {
  public static AwardSnowHeatDOExample initDOQueryFilter(Map<String, Object> filterMap) {
    AwardSnowHeatDOExample example = new AwardSnowHeatDOExample();
    ...
    AwardSnowHeatDOExample.Criteria criteria = example.createCriteria();
