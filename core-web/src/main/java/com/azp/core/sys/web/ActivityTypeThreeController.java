...
@Api(
    value = "activity_type_three",
    tags = "类型3活动管理"
)
@RestController
@RequestMapping("api/sys/activity/type/three")
public class ActivityTypeThreeController {
  @Autowired
  ...
  public Map<String, Object> getSimpleMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getSimpleMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getDetailMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getDetailMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getFilterMapList(@RequestParam(value = "id", required = false) String id,
    ...
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getFilterMapList(mapper))
        .addDataCount(activityTypeThreeService.getCountByFilter(mapper))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailMapList(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getFilterDetailMapList(mapper))
        .addDataCount(activityTypeThreeService.getCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> post(@RequestBody ActivityTypeThreePostMapper postMapper) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.postMapping(postMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> postBatch(@RequestBody ArrayList<ActivityTypeThreePostMapper> postMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.postMappingList(postMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patch(@RequestBody ActivityTypeThreeUpdateMapper updateMapper) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.updateMapping(updateMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patchBatch(@RequestBody ArrayList<ActivityTypeThreeUpdateMapper> updateMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.updateMappingList(updateMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> put(@RequestBody ActivityTypeThreeUpdateMapper putMapper) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.putMapping(putMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> putBatch(@RequestBody ArrayList<ActivityTypeThreeUpdateMapper> putMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.putMappingList(putMappers))
        .map();
  }
  ...
  public Map<String, Object> delete(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.delete(id))
        .map();
  }
  ...
  public Map<String, Object> deleteBatch(@RequestParam("entityKeys") ArrayList<String> entityKeys) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.deleteList(entityKeys))
        .map();
  }
  ...
  public Map<String, Object> getRateAndCountFilterMap(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getRateAndCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> getRateAndCountFilterMapList(@RequestBody ArrayList<ActivityTypeThreeFilterMapper> filterMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getRateAndCountListByFilter(filterMappers))
        .map();
  }
  ...
  public Map<String, Object> getFilterListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getFilterListGroup(mapper, groupBy))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeThreeService.getFilterDetailListGroup(mapper, groupBy))
        .map();
  }
}
