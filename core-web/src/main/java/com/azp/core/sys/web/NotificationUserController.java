...
@RestController
@RequestMapping("api/sys/notification/user")
public class NotificationUserController {
  ...
  public Map<String, Object> getSimpleMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.getSimpleMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getDetailMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.getDetailMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getFilterMapList(@RequestParam(value = "id", required = false) String id,
    ...
    return Status.successBuilder()
        .addDataValue(notificationUserService.getFilterMapList(mapper))
        .addDataCount(notificationUserService.getCountByFilter(mapper))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailMapList(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(notificationUserService.getFilterDetailMapList(mapper))
        .addDataCount(notificationUserService.getCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> post(@RequestBody NotificationUserPostMapper postMapper) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.postMapping(postMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> postBatch(@RequestBody ArrayList<NotificationUserPostMapper> postMappers) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.postMappingList(postMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patch(@RequestBody NotificationUserUpdateMapper updateMapper) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.updateMapping(updateMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patchBatch(@RequestBody ArrayList<NotificationUserUpdateMapper> updateMappers) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.updateMappingList(updateMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> put(@RequestBody NotificationUserUpdateMapper putMapper) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.putMapping(putMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> putBatch(@RequestBody ArrayList<NotificationUserUpdateMapper> putMappers) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.putMappingList(putMappers))
        .map();
  }
  ...
  public Map<String, Object> delete(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.delete(id))
        .map();
  }
  ...
  public Map<String, Object> deleteBatch(@RequestParam("entityKeys") ArrayList<String> entityKeys) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.deleteList(entityKeys))
        .map();
  }
  ...
  public Map<String, Object> getRateAndCountFilterMap(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(notificationUserService.getRateAndCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> getRateAndCountFilterMapList(@RequestBody ArrayList<NotificationUserFilterMapper> filterMappers) {
    return Status.successBuilder()
        .addDataValue(notificationUserService.getRateAndCountListByFilter(filterMappers))
        .map();
  }
  ...
  public Map<String, Object> getFilterListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(notificationUserService.getFilterListGroup(mapper, groupBy))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(notificationUserService.getFilterDetailListGroup(mapper, groupBy))
        .map();
  }
}
