...
@RestController
@RequestMapping("api/sys/use/info")
public class UseInfoController {
  ...
  public Map<String, Object> getSimpleMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(useInfoService.getSimpleMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getDetailMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(useInfoService.getDetailMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getFilterMapList(@RequestParam(value = "id", required = false) String id,
    ...
    return Status.successBuilder()
        .addDataValue(useInfoService.getFilterMapList(mapper))
        .addDataCount(useInfoService.getCountByFilter(mapper))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailMapList(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(useInfoService.getFilterDetailMapList(mapper))
        .addDataCount(useInfoService.getCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> post(@RequestBody UseInfoPostMapper postMapper) {
    return Status.successBuilder()
        .addDataValue(useInfoService.postMapping(postMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> postBatch(@RequestBody ArrayList<UseInfoPostMapper> postMappers) {
    return Status.successBuilder()
        .addDataValue(useInfoService.postMappingList(postMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patch(@RequestBody UseInfoUpdateMapper updateMapper) {
    return Status.successBuilder()
        .addDataValue(useInfoService.updateMapping(updateMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patchBatch(@RequestBody ArrayList<UseInfoUpdateMapper> updateMappers) {
    return Status.successBuilder()
        .addDataValue(useInfoService.updateMappingList(updateMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> put(@RequestBody UseInfoUpdateMapper putMapper) {
    return Status.successBuilder()
        .addDataValue(useInfoService.putMapping(putMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> putBatch(@RequestBody ArrayList<UseInfoUpdateMapper> putMappers) {
    return Status.successBuilder()
        .addDataValue(useInfoService.putMappingList(putMappers))
        .map();
  }
  ...
  public Map<String, Object> delete(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(useInfoService.delete(id))
        .map();
  }
  ...
  public Map<String, Object> deleteBatch(@RequestParam("entityKeys") ArrayList<String> entityKeys) {
    return Status.successBuilder()
        .addDataValue(useInfoService.deleteList(entityKeys))
        .map();
  }
  ...
  public Map<String, Object> getRateAndCountFilterMap(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(useInfoService.getRateAndCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> getRateAndCountFilterMapList(@RequestBody ArrayList<UseInfoFilterMapper> filterMappers) {
    return Status.successBuilder()
        .addDataValue(useInfoService.getRateAndCountListByFilter(filterMappers))
        .map();
  }
  ...
  public Map<String, Object> getFilterListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(useInfoService.getFilterListGroup(mapper, groupBy))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(useInfoService.getFilterDetailListGroup(mapper, groupBy))
        .map();
  }
}
