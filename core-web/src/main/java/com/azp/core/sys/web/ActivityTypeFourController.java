...
@Api(
    value = "activity_type_four",
    tags = "类型4活动管理"
)
@RestController
@RequestMapping("api/sys/activity/type/four")
public class ActivityTypeFourController {
  @Autowired
  ...
  public Map<String, Object> getSimpleMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getSimpleMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getDetailMapByPK(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getDetailMapByPK(id))
        .map();
  }
  ...
  public Map<String, Object> getFilterMapList(@RequestParam(value = "id", required = false) String id,
    ...
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getFilterMapList(mapper))
        .addDataCount(activityTypeFourService.getCountByFilter(mapper))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailMapList(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getFilterDetailMapList(mapper))
        .addDataCount(activityTypeFourService.getCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> post(@RequestBody ActivityTypeFourPostMapper postMapper) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.postMapping(postMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> postBatch(@RequestBody ArrayList<ActivityTypeFourPostMapper> postMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.postMappingList(postMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patch(@RequestBody ActivityTypeFourUpdateMapper updateMapper) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.updateMapping(updateMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> patchBatch(@RequestBody ArrayList<ActivityTypeFourUpdateMapper> updateMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.updateMappingList(updateMappers))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> put(@RequestBody ActivityTypeFourUpdateMapper putMapper) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.putMapping(putMapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> putBatch(@RequestBody ArrayList<ActivityTypeFourUpdateMapper> putMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.putMappingList(putMappers))
        .map();
  }
  ...
  public Map<String, Object> delete(@RequestParam(value = "id", required = true) String id) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.delete(id))
        .map();
  }
  ...
  public Map<String, Object> deleteBatch(@RequestParam("entityKeys") ArrayList<String> entityKeys) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.deleteList(entityKeys))
        .map();
  }
  ...
  public Map<String, Object> getRateAndCountFilterMap(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getRateAndCountByFilter(mapper))
        .map();
  }
  ...
  @ResponseBody
  public Map<String, Object> getRateAndCountFilterMapList(@RequestBody ArrayList<ActivityTypeFourFilterMapper> filterMappers) {
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getRateAndCountListByFilter(filterMappers))
        .map();
  }
  ...
  public Map<String, Object> getFilterListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getFilterListGroup(mapper, groupBy))
        .map();
  }
  ...
  public Map<String, Object> getFilterDetailListGroup(@RequestParam(value = "id", required = false) String id,
    ...
    mapper.orderBy = orderBy;
    return Status.successBuilder()
        .addDataValue(activityTypeFourService.getFilterDetailListGroup(mapper, groupBy))
        .map();
  }
}
