...
@Mapper(
    ...
    name = {"DepartmentPointData","DepartmentPointDomain","DepartmentPointFilterMapper","DepartmentPointPostMapper","DepartmentPointUpdateMapper","DepartmentPointSimpleMapper","DepartmentPointDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {DepartmentPointDO.class,DepartmentPointTO.class,}
)
