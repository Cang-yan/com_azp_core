...
@Mapper(
    ...
    name = {"AwardSpecialTimeData","AwardSpecialTimeDomain","AwardSpecialTimeFilterMapper","AwardSpecialTimePostMapper","AwardSpecialTimeUpdateMapper","AwardSpecialTimeSimpleMapper","AwardSpecialTimeDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {AwardSpecialTimeDO.class,AwardSpecialTimeTO.class,}
)
public class AwardSpecialTime {
  /**
   * 特殊时节奖ID */
  @MapperIgnore({"post",})
  private String id;
