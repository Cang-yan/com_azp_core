...
@Mapper(
    ...
    name = {"PointStoreData","PointStoreDomain","PointStoreFilterMapper","PointStorePostMapper","PointStoreUpdateMapper","PointStoreSimpleMapper","PointStoreDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {PointStoreDO.class,PointStoreTO.class,}
)
