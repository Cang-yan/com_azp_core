...
@Mapper(
    ...
    name = {"PointData","PointDomain","PointFilterMapper","PointPostMapper","PointUpdateMapper","PointSimpleMapper","PointDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","filter","filter","filter","filter","filter","filter","detail","detail",},
    name = {"page","rows","orderBy","typeIn","userIdIn","relationIdIn","getTimeFrom","getTimeTo","templateIdIn","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","user","activity",},
    type = {Long.class,Integer.class,String.class,Integer.class,String.class,String.class,Long.class,Long.class,String.class,Long.class,Long.class,Long.class,Long.class,Map.class,Map.class,},
    typeArgs = {"null","null","null","null","null","null","null","null","null","null","null","null","null","String, Object","String, Object",},
    list = {false,false,true,true,true,true,false,false,true,false,false,false,false,false,false}
)
@MapperConvert(
    value = {"data","domain",},
    type = {PointDO.class,PointTO.class,}
)
public class Point {
  /**
   * 积分ID */
