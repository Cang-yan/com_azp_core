...
@Mapper(
    ...
    name = {"DepartmentData","DepartmentDomain","DepartmentFilterMapper","DepartmentPostMapper","DepartmentUpdateMapper","DepartmentSimpleMapper","DepartmentDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail","detail","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","departmentPoint","userList","groupList",},
    ...
    list = {false,false,true,false,false,false,false,false,true,true,}
)
@MapperConvert(
    value = {"data","domain",},
    type = {DepartmentDO.class,DepartmentTO.class,}
)
