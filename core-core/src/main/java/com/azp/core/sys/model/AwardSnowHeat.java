...
@Mapper(
    ...
    name = {"AwardSnowHeatData","AwardSnowHeatDomain","AwardSnowHeatFilterMapper","AwardSnowHeatPostMapper","AwardSnowHeatUpdateMapper","AwardSnowHeatSimpleMapper","AwardSnowHeatDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {AwardSnowHeatDO.class,AwardSnowHeatTO.class,}
)
public class AwardSnowHeat {
  /**
   * 雪中送炭ID */
  @MapperIgnore({"post",})
  private String id;
