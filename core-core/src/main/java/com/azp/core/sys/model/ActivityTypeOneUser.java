...
@Mapper(
    ...
    name = {"ActivityTypeOneUserData","ActivityTypeOneUserDomain","ActivityTypeOneUserFilterMapper","ActivityTypeOneUserPostMapper","ActivityTypeOneUserUpdateMapper","ActivityTypeOneUserSimpleMapper","ActivityTypeOneUserDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","filter","detail","detail",},
    name = {"page","rows","orderBy","statusIn","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","user","activityTypeOne",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {ActivityTypeOneUserDO.class,ActivityTypeOneUserTO.class,}
)
public class ActivityTypeOneUser {
  /**
   * 类型1活动-用户ID */
  @MapperIgnore({"post",})
  private String id;
