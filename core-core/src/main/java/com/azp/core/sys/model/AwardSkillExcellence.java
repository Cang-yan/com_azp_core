...
@Mapper(
    ...
    name = {"AwardSkillExcellenceData","AwardSkillExcellenceDomain","AwardSkillExcellenceFilterMapper","AwardSkillExcellencePostMapper","AwardSkillExcellenceUpdateMapper","AwardSkillExcellenceSimpleMapper","AwardSkillExcellenceDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {AwardSkillExcellenceDO.class,AwardSkillExcellenceTO.class,}
)
public class AwardSkillExcellence {
  /**
   * 技能突出奖ID */
  @MapperIgnore({"post",})
  private String id;
