...
@Mapper(
    ...
    name = {"ThreeMonthExcellentData","ThreeMonthExcellentDomain","ThreeMonthExcellentFilterMapper","ThreeMonthExcellentPostMapper","ThreeMonthExcellentUpdateMapper","ThreeMonthExcellentSimpleMapper","ThreeMonthExcellentDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {ThreeMonthExcellentDO.class,ThreeMonthExcellentTO.class,}
)
public class ThreeMonthExcellent {
  /**
   * 季度优秀奖ID */
  @MapperIgnore({"post",})
  private String id;
