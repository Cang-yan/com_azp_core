...
import com.azp.core.sys.domain.TipsTO;
...
@Mapper(
    ...
    name = {"TipsData","TipsDomain","TipsFilterMapper","TipsPostMapper","TipsUpdateMapper","TipsSimpleMapper","TipsDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {TipsDO.class,TipsTO.class,}
)
public class Tips {
  /**
   * 小贴士ID */
