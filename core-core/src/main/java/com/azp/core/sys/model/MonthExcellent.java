...
@Mapper(
    ...
    name = {"MonthExcellentData","MonthExcellentDomain","MonthExcellentFilterMapper","MonthExcellentPostMapper","MonthExcellentUpdateMapper","MonthExcellentSimpleMapper","MonthExcellentDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {MonthExcellentDO.class,MonthExcellentTO.class,}
)
public class MonthExcellent {
  /**
   * 月度优秀奖ID */
  @MapperIgnore({"post",})
  private String id;
